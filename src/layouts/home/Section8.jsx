...
export default function Section8() {
    return (
        <section className="text-gray-600 body-font">
            <div className="container grid sm:grid-cols-2  py-24 mx-auto">
                <div className="flex flex-col  w-full mb-20 p-10">
                    ...
                    <img src={logo} alt="Fitsum Advert Logo" />
                </div>

                <div className="grid  sm:grid-cols-2   text-center">
                    <div className="p-4 w-full">
                        <div className="border-2 border-gray-200 flex flex-col items-center px-4 py-6 rounded-lg">
